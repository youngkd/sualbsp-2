...
\begin{table}[tpb]
	...
	\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
		...
		Assignment of tasks to stations & Sequencing of tasks within each station
	\end{tabular}
\end{table}
...
\begin{figure}
	...
	\only<2>{\includegraphics[width=0.8\textwidth]{images/ourBendersHighestLevel-1.eps}}%
	\only<3>{\includegraphics[width=0.8\textwidth]{images/ourBendersHighestLevel-2.eps}}%
	\only<4>{\includegraphics[width=0.8\textwidth]{images/ourBendersHighestLevel-3.eps}}%
\end{figure}
